...
def track_event(
    ...
    Args:
        ...
        event_type: "sent", "opened", "clicked", "replied", "converted", "made", "answered", etc.
        channel: "email", "sms", "linkedin", "call"
        metadata: optional dict (timestamp, IP, user_agent, etc)
    """
    lead_id = lead.get("id")
    ...
    # Standardize channel prefix
    event_name = f"{channel}_{event_type}" if channel != "email" else event_type

    handle_event(event_name, campaign_id, lead_id=lead_id, metadata=metadata)


# --------------------------------------------------
# Email Convenience Functions
# --------------------------------------------------
def track_email_sent(lead_id: int, campaign_id: int, metadata: Optional[Dict] = None):
    track_event({"id": lead_id, "campaign_id": campaign_id}, "sent", "email", metadata)

def track_email_open(lead_id: int, campaign_id: int, metadata: Optional[Dict] = None):
    track_event({"id": lead_id, "campaign_id": campaign_id}, "opened", "email", metadata)

def track_link_click(lead_id: int, campaign_id: int, metadata: Optional[Dict] = None):
    track_event({"id": lead_id, "campaign_id": campaign_id}, "clicked", "email", metadata)

def track_reply(lead_id: int, campaign_id: int, metadata: Optional[Dict] = None):
    track_event({"id": lead_id, "campaign_id": campaign_id}, "replied", "email", metadata)

def track_email_failed(lead_id: int, campaign_id: int, metadata: Optional[Dict] = None):
    track_event({"id": lead_id, "campaign_id": campaign_id}, "failed", "email", metadata)

def track_conversion(lead_id: int, campaign_id: int, metadata: Optional[Dict] = None):
...
# --------------------------------------------------
def track_sms_sent(lead_id: int, campaign_id: int, metadata: Optional[Dict] = None):
    track_event({"id": lead_id, "campaign_id": campaign_id}, "sent", "sms", metadata)

def track_sms_clicked(lead_id: int, campaign_id: int, metadata: Optional[Dict] = None):
    track_event({"id": lead_id, "campaign_id": campaign_id}, "clicked", "sms", metadata)

def track_sms_replied(lead_id: int, campaign_id: int, metadata: Optional[Dict] = None):
...
# --------------------------------------------------
def track_linkedin_message_sent(lead_id: int, campaign_id: int, metadata: Optional[Dict] = None):
    track_event({"id": lead_id, "campaign_id": campaign_id}, "sent", "linkedin", metadata)

def track_linkedin_clicked(lead_id: int, campaign_id: int, metadata: Optional[Dict] = None):
    track_event({"id": lead_id, "campaign_id": campaign_id}, "clicked", "linkedin", metadata)

def track_linkedin_replied(lead_id: int, campaign_id: int, metadata: Optional[Dict] = None):
...
# --------------------------------------------------
def track_call_made(lead_id: int, campaign_id: int, metadata: Optional[Dict] = None):
    track_event({"id": lead_id, "campaign_id": campaign_id}, "made", "call", metadata)

def track_call_answered(lead_id: int, campaign_id: int, metadata: Optional[Dict] = None):
